 ...
 */
export function BlackjackRules({ config: brut }: { config: GameConfig }) {
  // Le registre des règles passe la config commune ; ce jeu lit en plus ses
  // propres champs (gains, règle du croupier).
  const config = brut as BlackjackConfig;
  return (
    <>
